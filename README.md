# GopenPGP V2
[![Build Status](https://travis-ci.org/rohautl/gopenpgp.svg?branch=master)](https://travis-ci.org/rohautl/gopenpgp)
...
require (
    ...
    github.com/rohautl/gopenpgp/v2 v2.0.1
)
```
...
import (
	"fmt"
	"github.com/rohautl/gopenpgp/v2/crypto"
)
...
git clone git@github.com:rohautl/gopenpgp.git
cd gopenpgp
ln -s . v2
go mod
```
...
https://godoc.org/gopkg.in/rohautl/gopenpgp.v2/crypto
